...
openai.api_type = os.get(env("OPENAI_API_TYPE", "-"))
openai.api_base = os.get(env("OPENAI_API_BASE", "https://api.openai.com"))
openai.api_key = os.getenv("OPENAI_API_KEY", "-")
openai.api_version = os.get(env("OPENAI_API_VERSION", "-"))
